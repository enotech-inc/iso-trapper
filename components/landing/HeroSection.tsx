      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 lg:grid-cols-2 lg:items-center">
        <div className="flex flex-col items-start">
          <Badge tone="accent" className="mb-4">
            Tailwind-first interaction tooling
          </Badge>
          <h1 className="text-left text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl lg:text-6xl dark:text-white">
            Build spatial UI interactions with confidence.
          </h1>
          <p className="mt-6 max-w-2xl text-left text-lg leading-8 text-slate-600 dark:text-slate-300">
            Isotrapper helps developers orchestrate layered interfaces, motion
            states, and keyboard-safe traps with a clean API designed for modern
            React apps.
          </p>

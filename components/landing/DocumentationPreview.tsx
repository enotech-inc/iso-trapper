...
const docItems = [
  {
    ...
    detail: "Install, configure, and render your first trap.",
  },
  {
    title: "Trap Patterns",
    detail: "Apply reveal, focus, dock, and scroll lock compositions.",
  },
  {
    title: "Design System",
    detail: "Token guidance, spacing rules, and motion consistency.",
  },
];
